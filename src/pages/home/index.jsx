    ...
    <HomeContainer>
      <section id="home">
        <div className="section-info">
          ...
          <p>Seja um reflexo do melhor que você pode desejar para si mesma.</p>
      ...
      <div className="second-info-container">
        ...
        <div className="box-info-container">
          <div>
            <h1>Local</h1>
            <p>
              Nosso espaço está no Porto, em Porto/Rua Santa Catarina 1557 piso
              1 loja 30 galerias Atlantis.
              <br />
              <br />
              <a
          ...
          <div>
            <h1>Qualidade</h1>
            <p>
              Os serviços são todos feitos com excelência e qualidade. Aqui, se
              apresenta o melhor atendimento possível. Sem esforços para você
              sair mais linda do que o normal.
            </p>
          </div>
          <div>
            <h1>Agendamento</h1>
            <p>
              Para agendar seu atendimento pode entrar em contato via whatsApp e
              instagram. E terá um retorno no mesmo momento ou o mais breve
              possível.
            </p>
          </div>
        </div>
      ...
      <div id="schedule">
        ...
        <p>
          Faça um contacto via Instagram ou Whatsapp clicando no ícone acima, e
          vamos fazer o agendamento para cuidar com todo amor de suas lindas
          sobrancelhas.
        </p>
      </div>
    </HomeContainer>
